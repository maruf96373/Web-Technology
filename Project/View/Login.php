...
<body>
        ...
        <tr>
            <td><table><tr><td width="404">Click & Stay</td><td align=right>  <a style="color:rgb(0, 102, 255);" href="Registration.php">Registration</a>
</td></tr></table></td>
        </tr>
        <tr  style="height:250;">
            <td align="center">
        ...
        <fieldset style="width: 300;">
           <legend><b>LOGIN</b></legend>
            <table>
                <tr>
            <td align="left">Username </td><td><span style="padding: 3px;">:<input type="text" name="username" value=""></span></td>
</tr>
<tr>
